...
export const mockRestaurants: Restaurant[] = [
  ...
  { id: 3, name: 'Saffron Yard', address: '88 Highline Blvd', phone: '+1 555 410 9003', email: 'contact@saffronyard.example', logoUrl: '', description: 'Modern South Asian dining.', openingHours: 'Mon-Sat: 17:00 - 23:30', serviceChargePercentage: 10, taxPercentage: 7.5, currencyCode: 'LKR', themeColor: '#ef4444', status: 'SUSPENDED', planName: 'Starter', createdAt: '2026-04-09T09:00:00Z' },
];
